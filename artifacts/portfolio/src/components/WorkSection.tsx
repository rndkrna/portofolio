...
const fallbackProjects = [
  {
    ...
    type: "Fullstack",
    description:
      "Membangun platform media berita digital secara end-to-end dengan skema basis data relasional yang efisien untuk mengelola artikel, multimedia, dan proteksi admin dari serangan brute force.",
  ...
  },
  {
    ...
    type: "Frontend",
    description:
      "Merancang website profil perusahaan responsif dengan optimasi loading time melalui manajemen aset visual dan penerapan SEO dasar.",
  ...
  },
  {
    ...
    type: "Fullstack",
    description:
      "Mengembangkan sistem informasi beasiswa terenkripsi dengan algoritma Scrypt, HKDF, dan AES-256-GCM guna menjamin keamanan data sensitif mahasiswa.",
  ...
  return (
    <section id="work" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute top-1/3 left-[-10%] w-[50vw] h-[50vw] rounded-full"
          style={{
            background:
        ...
        />
        <div
          className="absolute bottom-1/4 right-[-10%] w-[45vw] h-[45vw] rounded-full"
          style={{
            background:
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(249,168,212,0.4), transparent)",
            }}
          />
          <span
        ...
        >
          ...
          >
            ...
            <span
              className="block animate-pulse-glow"
              style={{
