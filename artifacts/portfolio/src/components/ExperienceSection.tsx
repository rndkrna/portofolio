...
const fallbackExperiences = [
  {
    ...
    description:
      "Membangun platform media berita digital secara end-to-end. Merancang skema basis data relasional serta mengamankan situs dari serangan brute force pada halaman login admin.",
  },
  {
    ...
    period: "Mar 2026",
    description:
      "Merancang website profil perusahaan responsif (Mobile & Desktop), melakukan manajemen aset visual untuk optimasi loading time, dan menerapkan SEO dasar.",
  },
  {
    ...
    description:
      "Memimpin tim dalam merancang membuat rekomendasi kebijakan organisasi berbasis data.",
  },
  {
    ...
    period: "2025",
    description:
      "Mengembangkan sistem beasiswa terenkripsi dengan kriptografi modern (Scrypt, HKDF, AES-256-GCM) serta melakukan pengujian skenario kerentanan siber.",
  },
  {
    ...
    period: "2023 — 2024",
    description:
      "Merancang kurikulum kepemimpinan tingkat organisasi dan mengelola tim pendampingan advokasi anggota secara terstruktur.",
  },
];
...
export default function ExperienceSection() {
  ...
  const displayExperiences =
    dbExperiences === undefined ? fallbackExperiences : dbExperiences;
  ...
  return (
    <section id="experience" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute bottom-[10%] left-[5%] w-[45vw] h-[45vw] rounded-full"
          style={{
            background:
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(103,232,249,0.4), transparent)",
            }}
          />
        </motion.div>
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(167,139,250,0.4) 0%, rgba(219,39,119,0.3) 40%, rgba(6,182,212,0.2) 70%, rgba(34,211,238,0.1) 100%)",
            }}
          />
          ...
          <div className="space-y-12">
            {displayExperiences.map((exp, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`relative flex flex-col md:flex-row items-stretch md:justify-between ${isOdd ? "md:flex-row-reverse" : ""}`}
                >
                  {/* Glowing Node Point */}
                  <div
                  ...
                  <div className="w-full md:w-[45%] pl-10 md:pl-0 flex flex-col items-stretch">
                    <motion.div
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <h3 className="font-display uppercase text-xl text-white tracking-wide leading-tight">
                            {exp.role}
                          </h3>
                          <p
                            className="font-sans font-bold text-xs uppercase tracking-wider mt-0.5"
                            style={{ color }}
                          >
                            @ {exp.company}
                          </p>
